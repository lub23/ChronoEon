...
// Tauri 2.11 names the generated mobile project after the app. Existing
// projects created by older CLIs remain at gen/android, so prefer the new
// project when it is present (CI initializes it before this script runs).
const generatedAndroidRoot = join(androidRoot, "chronoeon_app");
const projectRoot = existsSync(generatedAndroidRoot)
